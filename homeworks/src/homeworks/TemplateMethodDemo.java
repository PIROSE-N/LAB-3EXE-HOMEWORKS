...
public class TemplateMethodDemo {
	public static void main(String[] args) {
		Sangeetha sangeethaHotel=new Shoib();
...
abstract class Sangeetha{
	...
	public final void createIdlyPlate() {
		System.out.println("sangeetha how to create a idly plate....");
	}
...
class Shoaib extends Sangeetha{
	
	public void makeIdly() {
		System.out.println("my granma makes the idly in my hotel....");
	}
